-- ============================================================
-- FusionFit Gym Management System — Migration V39
-- Secure Online Invoice Token & Public Link Integration
-- ============================================================

-- Ensure invoice_token column exists on public.invoices
ALTER TABLE public.invoices
  ADD COLUMN IF NOT EXISTS invoice_token VARCHAR UNIQUE;
...
-- Backfill tokens for existing invoices missing tokens
